...
class WorksTableSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        for ($i = 0; $i < 50; $i++)
        {
            ...
            {
                $img_one = 'https://picsum.photos/id/'. rand(0, 1084);
            };
            if (rand(0,1) == 0) //img_two
            {
                $img_two = 'https://picsum.photos/id/'. rand(0, 1084);
            };
            if (rand(0,1) == 0) //img_three
            {
                $img_three = 'https://picsum.photos/id/'. rand(0, 1084);
            };
            ...
            Work::create([
                ...
                'image_large' => 'https://picsum.photos/id/'. rand(0, 1084),
